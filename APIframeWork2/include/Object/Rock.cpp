...
void Rock::DestroyRock()
{
	...
	if (fRate <= m_fGemsDropRate)
	{
		...
		{
		case ROCK_NONE:
			pRock = (Item*)CreateCloneObj("Shingle", "Shingle", m_pScene->GetSceneType(), m_pLayer);
			break;
		case ROCK_EMER:
			pRock = (Item*)CreateCloneObj("Emerald", "Emerald", m_pScene->GetSceneType(), m_pLayer);
			break;
		case ROCK_AQUA:
			pRock = (Item*)CreateCloneObj("Aquamarine", "Aquamarine", m_pScene->GetSceneType(), m_pLayer);
			break;
		case ROCK_RUBY:
			pRock = (Item*)CreateCloneObj("Ruby", "Ruby", m_pScene->GetSceneType(), m_pLayer);
			break;
		case ROCK_AMET:
			pRock = (Item*)CreateCloneObj("Amethyst", "Amethyst", m_pScene->GetSceneType(), m_pLayer);
			break;
		case ROCK_TOPA:
			pRock = (Item*)CreateCloneObj("Topaz", "Topaz", m_pScene->GetSceneType(), m_pLayer);
			break;
		case ROCK_JADE:
			pRock = (Item*)CreateCloneObj("Jade", "Jade", m_pScene->GetSceneType(), m_pLayer);
			break;
		case ROCK_DIAM:
			pRock = (Item*)CreateCloneObj("Diamond", "Diamond", m_pScene->GetSceneType(), m_pLayer);
			break;
		case ROCK_PRIS:
			pRock = (Item*)CreateCloneObj("PrismaticShard", "PrismaticShard", m_pScene->GetSceneType(), m_pLayer);
			break;
		}
	...
	Obj* pEffect = CreateCloneObj("HoeEffect", "RockEffect", SC_CURRENT, m_pLayer);
